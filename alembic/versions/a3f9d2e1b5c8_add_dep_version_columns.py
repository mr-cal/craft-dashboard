...
down_revision: str | None = "b67acfce407c"
...
def upgrade() -> None:
    op.add_column(
        "dependencies", sa.Column("installed_version", sa.String(255), nullable=True)
    )
    op.add_column(
        "dependencies", sa.Column("latest_version", sa.String(255), nullable=True)
    )
