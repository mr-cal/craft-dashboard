...
down_revision: str | None = "d89e58e0a23e"
...
def upgrade() -> None:
    op.add_column(
        "snapshots",
        sa.Column("median_issue_age", sa.Integer(), nullable=False, server_default="0"),
    )
    op.add_column(
        "snapshots",
        sa.Column("median_pr_age", sa.Integer(), nullable=False, server_default="0"),
    )
    op.add_column(
        "snapshots",
    ...
    op.add_column(
        "snapshots",
        sa.Column("closed_prs", sa.Integer(), nullable=False, server_default="0"),
    )
    op.add_column(
        "snapshots",
        sa.Column(
            "closed_issues_external", sa.Integer(), nullable=False, server_default="0"
        ),
    )
    op.add_column(
        "snapshots",
        sa.Column(
            "closed_issues_internal", sa.Integer(), nullable=False, server_default="0"
        ),
    )
    op.add_column(
        "snapshots",
        sa.Column(
            "closed_prs_external", sa.Integer(), nullable=False, server_default="0"
        ),
    )
    op.add_column(
        "snapshots",
        sa.Column(
            "closed_prs_internal", sa.Integer(), nullable=False, server_default="0"
        ),
    )
