...
down_revision: str | None = "5d2a2a5c1823"
...
def upgrade() -> None:
    ...
    op.create_unique_constraint(
        "uq_releases_project_id_branch", "releases", ["project_id", "branch"]
    )
...
def downgrade() -> None:
    ...
    op.create_unique_constraint(
        "releases_project_id_version_key", "releases", ["project_id", "version"]
    )
